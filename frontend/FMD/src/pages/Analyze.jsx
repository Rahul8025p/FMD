...
export default function Analyze() {
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      // ✅ Handle cattle rejection from Claude validation (400 + rejected flag)
      if (status === 400 && data?.rejected) {
        setError("");
        setToast(serverMessage || t("analyze.validCowOnly", "Please upload a valid cattle image — full body or close-up of mouth/hoof."));
        return;
      }
